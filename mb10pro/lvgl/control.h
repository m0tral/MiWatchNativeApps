#ifndef MB10P_LVGL_CONTROL_H
#define MB10P_LVGL_CONTROL_H

/* mb10pro LVGL control-widget constructors + generic methods.
 *
 ...
 * live in platform/mb10p_platform.h.
 *
...
typedef void (*lv_btn_set_text_t)    (lv_obj_t *btn, const char *text, ...);
...
typedef int  (*lvx_obj_set_style_text_t)(lv_obj_t *obj,
                                          ...
                                          lv_opa_t opa,
                                          lv_style_selector_t selector);
typedef void (*lvx_obj_set_style_bg_color_t)(lv_obj_t *obj, lv_color_t color);
...
lv_obj_t *lv_btn2_create            (lv_obj_t *parent);   /* miwear-specific button class (0x2CA48474) */
...
void lvx_obj_set_style_bg_color    (lv_obj_t *obj, lv_color_t color);
