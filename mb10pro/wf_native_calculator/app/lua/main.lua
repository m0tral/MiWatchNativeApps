...
local FW_TO_APP = {
    ["3.101.043"] = "mb10p_app_3.101.043.elf",
    ["3.121.043"] = "mb10p_app_3.101.043.elf",
    ["3.201.016"] = "mb10p_app_3.201.016.elf",
    ["3.221.016"] = "mb10p_app_3.201.016.elf",
}
...
local MODULE_NAME = "mb10p_app"

local APP_SRC     = SCRIPT_PATH .. APP_NAME
local APP_DST     = "/data/mb10p_com.m0tral.calculator.elf"
