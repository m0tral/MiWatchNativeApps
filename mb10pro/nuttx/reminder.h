...
/* mb10pro LVGL reminder subsystem.
 *
...
#include <stdint.h>
#include "lvgl/control.h"   /* for lv_obj_t (used in lvx_reminder_lifecycle_t below) */
 ...
 * mb10p_platform.h as `#define`s of the same name -- a TU must
 * include mb10p_platform.h to actually call any of these, which is
