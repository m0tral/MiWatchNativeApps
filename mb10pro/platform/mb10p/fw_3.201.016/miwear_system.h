...
#define lv_btn2_create                ((lv_class_create_t)(0x2C77F734 | 1))                               /* Thumb bit set (lv_btn2_create in fw) */
...
#define lv_btn_set_text               ((lv_btn_set_text_t)  (0x2C77F948 | 1))                              /* Thumb bit set */
...
#define lvx_obj_set_style_bg_color    ((lvx_obj_set_style_bg_color_t)(0x2C77F7D0 | 1))                        /* Thumb bit set */
