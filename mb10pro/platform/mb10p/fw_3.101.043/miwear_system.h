...
#include "nuttx/reminder.h"
#include "nuttx/notification.h"
#include "nuttx/screen.h"
#include "lvgl/timer.h"
#include "lvgl/control.h"
#include "miwear/app.h"
#include "miwear/watchface.h" /* for watchface_config_t and watchface_manager_delete_watchface_t */
#include "misc/print.h" /* for the snprintf prototype */
...
#define lv_btn2_create                ((lv_class_create_t)(0x2CA48474 | 1))                               /* Thumb bit set (lv_btn2_create in fw) */
...
#define lv_btn_set_text               ((lv_btn_set_text_t)  (0x2CA48688 | 1))                              /* Thumb bit set */
...
#define lvx_obj_set_style_bg_color    ((lvx_obj_set_style_bg_color_t)(0x2CA48510 | 1))                        /* Thumb bit set */
