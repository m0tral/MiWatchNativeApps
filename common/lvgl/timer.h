#ifndef XIAOMI_TIMER_H
#define XIAOMI_TIMER_H

/* watchs3 LVGL timer API typedefs.
 *
 ...
 * bit set) live in watchs3_platform.h. This header owns only the C
