#ifndef XIAOMI_SYSLOG_H
#define XIAOMI_SYSLOG_H

/* watchs3 firmware syslog -- signature and level enum.
 *
 * Level values reverse-engineered from vela_ap.bin (fw_4.8.0):
 ...
 * lives in watchs3_platform.h. */
typedef int (*syslog_t)(int level, const char *fmt, ...);

#endif /* XIAOMI_SYSLOG_H */
